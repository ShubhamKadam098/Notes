...
import { ArchiveRestore, HomeIcon, Menu, Trash2 } from "lucide-react";
...
const MobileSidebar = () => {
  return (
    <Sheet key={"left"}>
      ...
      <SheetContent
        side={"left"}
        className="w-1/2 bg-gray-50 p-0 dark:bg-gray-800"
      >
        <SheetHeader className="h-full">
          <SheetDescription className="h-full">
            <div className="h-full overflow-y-auto px-3 py-4">
              <ul className="flex h-full flex-col justify-between space-y-2 pt-6 font-medium">
                <div className="flex flex-col gap-3 text-[16px] font-semibold">
                  ...
                  <li>
                    ...
                    >
                      <ArchiveRestore />
                      <span className="ms-3 whitespace-nowrap">Archive</span>
                    </Link>
                  </li>
                  <li>
                    <a
                    ...
                    >
                      <Trash2 />
                      <span className="ms-3 whitespace-nowrap">Bin</span>
                    </a>
                  </li>
                </div>
